...
def generate_enfusion_polyline(origin, points):
    """
    ...
    entity.append('  ShapePoint "{0}" {{'.format(generate_random_id()))
...
# Test the generate_polyline_entity function
origin = (13480, 49.563, 10860)
points = [(10, 0, 10), (10, 10, 0), (0, 10, 0)]
generate_enfusion_polyline(origin, points)
